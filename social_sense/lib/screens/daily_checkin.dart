...
class DailyCheckInScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea( // Ensures content is below the status bar
        child: Container(
              ...
              children: [
                ...
                Expanded(
                  child: GridView.count(
                    ...
                    crossAxisSpacing: 25, // Feelings button spacing left & right
                    mainAxisSpacing: 25, // Feelings button spacing above & under
                    padding: const EdgeInsets.symmetric(horizontal: 40.0),
                    shrinkWrap: true, // Prevents excessive height use
                    childAspectRatio: 1.4, // Makes buttons more square
                    children: [
                      _buildEmotionButton(context, "Happy", const Color(0xFFFFEE6A)),
                      _buildEmotionButton(context, "Sad", const Color(0xFF99BEEE)),
                      _buildEmotionButton(context, "Angry", const Color(0xFFB45E5E)),
                      _buildEmotionButton(context, "Calm", const Color(0xFFFFFFFF)),
                      _buildEmotionButton(context, "Excited", const Color(0xFF75CE54)),
                      _buildEmotionButton(context, "Frustrated", const Color(0xFFB192CC)),
                    ],
                  ),
                ),
              ],
  ...
  Widget _buildEmotionButton(BuildContext context, String emotion, Color bgColor) {
    return SizedBox(
